...
class LibraryEmployee(Employee):
    def __init__(self, num_id: str, name: str, last_name: str, age: str, address: str, phone_number: str, salary: float, is_admin: bool) -> None:
